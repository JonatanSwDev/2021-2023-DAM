...
public class Sprite extends Thread{
	...
	private final String rutaSpriteTocado;
	...
	public Sprite(int ancho, int alto, String rutaSprite, String rutaSpriteTocado, Sincroniza sincro, Objetivo objetivo) {
		Random aleatorio = new Random();
		this.alto = alto;
		this.ancho = ancho;
		this.sincro = sincro;
		this.rutaSprite = rutaSprite;
		this.rutaSpriteTocado = rutaSpriteTocado;
	...
	public void run() {
		...
		while(!finPartida) {
			try {
				if ((objetivo.esDisparado()) && (posi.esMisma(objetivo.getPosicion())) ) {
					tocado = true;
				}
	...
	public String getRutaSprite() {
		String ruta;
		//si se ha disparado vemos si nos golpea
		if (tocado) {
			ruta = rutaSpriteTocado;
		}
		else {
		    ruta = rutaSprite;	
		}
